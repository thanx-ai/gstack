...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, slate, cursor, hermes, gbrain];
...
export { claude, codex, factory, kiro, opencode, slate, cursor, hermes, gbrain };
